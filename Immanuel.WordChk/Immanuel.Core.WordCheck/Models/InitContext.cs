...
namespace Immanuel.Core.WordCheck.App_Start
{
    public class WordContext
    {
        ...
        public static void Start(string pPath)
        {
            ...
            Rank = JsonConvert.DeserializeObject<Models.Ranking>(File.ReadAllText(Path.Combine(System.IO.Path.Combine(System.IO.Directory.GetCurrentDirectory(), "Data"), "config.json")));
